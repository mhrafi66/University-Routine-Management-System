...
public class MakeScheduleThree extends JFrame implements ActionListener{
    String departments,semesters;
    
    ImageIcon Icon;
    Container c;
    JLabel Teacher, Code, Name, Designation,Dept,Semester,Course;
    JButton Add, Update, Delete,Back,Clear,ShowAll,SetBatch;
    JTextField code, name, designation;
    JTextArea Info;
    JComboBox department,semester,course;
    String dept,sem,crs;
    int sems;
    JScrollPane Scroll;
    ...
    public void doSchedule()
    {
         ...
         Teacher= new JLabel("Delete By Course");
         Teacher.setBounds(160, 40, 350, 90);
         Teacher.setFont(f);
         ...
         Dept.setBounds(60, 140, 150, 50);
         Dept.setFont(f);
         Dept.setForeground(Color.BLUE);
         c.add(Dept);
         
         department = new JComboBox();
         department.setBounds(185, 140, 150, 50);
         ...
         Course.setBounds(60, 260, 150, 50);
         Course.setFont(f);
         Course.setForeground(Color.BLUE);
         c.add(Course);
         
         course = new JComboBox();
         course.setBounds(185, 260, 150, 50);
         course.setFont(f);
         course.setForeground(Color.BLUE);
         c.add(course);
        ...
        SetBatch= new JButton("SetBatch");
        SetBatch.setBounds(350,140,150,50);
        SetBatch.setFont(f);
        SetBatch.setForeground(Color.BLUE);
         c.add(SetBatch);
         ...
         SetBatch.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==department){
            ...
            String s=course.getSelectedItem().toString();
            crs=s;
            try {
                Routine.deleteInfo(crs);
            } catch (SQLException ex) {
                Logger.getLogger(MakeScheduleThree.class.getName()).log(Level.SEVERE, null, ex);
            }
            int smst=Integer.parseInt(sem);
            setTable(dept,smst);
            
        }
        else if(e.getSource()==SetBatch){
           String s;
